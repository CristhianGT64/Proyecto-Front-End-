          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item active">
                <a class="nav-link" href="{{route('negocio.menuPrincipal')}}">Inicio Negocio<span class="sr-only">(current)</span></a>
              </li>
      
            </ul>
      
            <a class="btn btn-outline-secondary mx-3" href="{{route('Login')}}">Cerrar sesion </a>
        ...
        <tbody>
            ...
            @foreach($pedidos as $pedido)
                <tr class="text-center">
                    ...
                    <td><a href="{{route('Reporte.GenerarReportePedidoNegocio',['idPedido'=> $pedido['idPedido'] , 'idNegocio'=> $idNegocio])}}" type="button" class="btn btn-primary">Ver Reporte</a></td>
                </tr>
            @endforeach
        </tbody>
    </table>
