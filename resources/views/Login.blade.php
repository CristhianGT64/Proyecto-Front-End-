...
<head>
    ...
    <Style>
        body{
            background-image: url('https://blog.neemo.com.br/wp-content/uploads/2018/07/neemo_neemo_image_307-scaled.jpeg');
    ...
    <div class="mt-3">
        <form action="{{route('usuario.Login')}}" method="POST">
            ...
            @csrf
                ...
                <div>
                <br>
                <a  class="text-decoration-none text-primary fw-bold fst-italic" href="{{route('usuario.CrearUsusario')}}">Crear un nuevo Usuario</a>
                <br>
                </div>
                <br>    
